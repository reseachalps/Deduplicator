...
public class RecordComparatorJaroWinkler extends RecordComparator{



	public RecordComparatorJaroWinkler(Attribute attributeRecord1, Attribute attributeRecord2) {
	...
	public StringMetric stringMetric() {
		return StringMetrics.jaroWinkler();
	}
